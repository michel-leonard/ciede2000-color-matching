...
**Purpose** : ΔE2000 is an algorithm designed to reflect the perceptual difficulty of distinguishing between two colors, rather than acting like a locally smooth and uniform Euclidean metric.

## Implementations

Engineered for precision and portability, this **reference** implementation of the **Delta E 2000** formula achieves color difference calculations accurate to 10 decimal places, and supports a wide range of programming languages :

|Paradigm / Ecosystem|Programming Languages|
|--:|:--|
|Low-Level / Systems|[C++](tests/cpp#δe2000--accurate-fast-c-powered) … [C](tests/c#δe2000--accurate-fast-c-powered) … [D](tests/d#δe2000--accurate-fast-d-powered) … [Go](tests/go#δe2000--accurate-fast-go-powered) … [Rust](tests/rs#δe2000--accurate-fast-rust-powered) … [Swift](tests/swift#δe2000--accurate-fast-swift-powered) … [Zig](tests/zig#δe2000--accurate-fast-zig-powered)|
|General Purpose / Scripting|[Dart](tests/dart#δe2000--accurate-fast-dart-powered) … [JavaScript](tests/js#δe2000--accurate-fast-javascript-powered) … [Lua](tests/lua#δe2000--accurate-fast-lua-powered) … [PHP](tests/php#δe2000--accurate-fast-php-powered) … [Perl](tests/pl#δe2000--accurate-fast-perl-powered) … [Python](tests/py#δe2000--accurate-fast-python-powered) … [Ruby](tests/rb#δe2000--accurate-fast-ruby-powered) … [TypeScript](tests/ts#δe2000--accurate-fast-typescript-powered) … [Wren](tests/wren#δe2000--accurate-fast-wren-powered)|
|Functional / Declarative|[Haskell](tests/hs#δe2000--accurate-fast-haskell-powered) … [Haxe](tests/hx#δe2000--accurate-fast-haxe-powered) … [Nim](tests/nim#δe2000--accurate-fast-nim-powered) … [Racket](tests/rkt#δe2000--accurate-fast-racket-powered)|
|VM-Based|[C#](tests/cs#δe2000--accurate-fast-c-powered) … [F#](tests/fs#δe2000--accurate-fast-f-powered) … [Java](tests/java#δe2000--accurate-fast-java-powered) … [Kotlin](tests/kt#δe2000--accurate-fast-kotlin-powered) … [VBA](tests/bas#δe2000--accurate-fast-vba-powered)|
|Scientific / Analytical|[Excel](tests/xls#δe2000--accurate-fast-excel-powered) … [Julia](tests/jl#δe2000--accurate-fast-julia-powered) … [MATLAB](tests/m#δe2000--accurate-fast-matlab-powered) … [Mathematica](tests/wls#δe2000--accurate-fast-mathematica-powered) … [R](tests/r#δe2000--accurate-fast-r-powered)|
|Legacy / Query|[ASP](ciede-2000.asp#L17) … [AWK](tests/awk#δe2000--accurate-fast-awk-powered) … [Fortran](tests/f90#δe2000--accurate-fast-fortran-powered) … [Pascal](tests/pas#δe2000--accurate-fast-pascal-powered) … [SQL](tests/sql#δe2000--accurate-fast-sql-powered)|

**Quality Assurance** : These implementations are validated against both the **Netflix VMAF library**, an Emmy-winning standard in video quality assessment, and the authoritative ΔE2000 formulation by **Gaurav Sharma** at the University of Rochester, among others, ensuring [scientific](tests#comparison-with-university-of-rochester-worked-examples) rigor and [practical](tests/c#comparison-with-the-vmaf-c99-library) reliability.
...
**Correctness**: The most valuable companies in the world today rely on CIE2000 and are encouraged, along with software developers, to conduct tests that reveal what truly breaks consistency across different implementations.
...
The ΔE2000 formula involves several numerically sensitive calculations, especially those related to π. In 32-bit floating point, rounding at each step can shift conditional logic into a different execution branch. Once in a different branch, the result may jump, it's more of a natural consequence of the formula's structure than a bug. These are not errors, but expected divergences due to precision limits. They occur only for ΔE values far outside the typical or industrial relevance range (i.e., above 60 or even 100), with 1 problematic case observed every 50 million tests.

Current implementations favor **64-bit precision**. However, for ΔE00 values within the [0–10] range — which is most relevant for UI design, print tolerancing, and perceptual testing — both 32-bit and 64-bit calculations yield virtually identical results, with typical deviations around ±0.0002 in Delta E 2000.

<details>
<summary>Can we remove the cross-implementation consistent rounding ?</summary>

Most of the time it's not necessary, but yes.
</details>
...
> [!NOTE]
> If the `atan2` function is not available in your chosen language, you can use the polyfill provided in the [ASP](ciede-2000.asp#L32) and [VBA](ciede-2000.bas#L26) versions. Similarly, when `hypot` is not available, the polyfill template can be found in the [Lua](ciede-2000.lua#L16) version.
