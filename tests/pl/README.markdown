...
This reference implementation in **Perl** offers a simple way of calculating these differences accurately and programmatically.
...
Where the main files involved are [ciede-2000-driver.pl](ciede-2000-driver.pl#L87) for calculations and [test-pl.yml](../../.github/workflows/test-pl.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=96.9&a1=-59.79&b1=95.34&L2=88.21&a2=25.24&b2=-35.11) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
