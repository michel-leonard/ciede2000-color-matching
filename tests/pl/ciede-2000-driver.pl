...
# L1 = 55.2   a1 = 19.6   b1 = 5.5
# L2 = 57.1   a2 = 13.6   b2 = -2.9
# CIE ΔE00 = 7.1809662179 (Bruce Lindbloom, Netflix’s VMAF, ...)
# CIE ΔE00 = 7.1809797615 (Gaurav Sharma, OpenJDK, ...)
...
# in Perl displays the original line with the computed Delta E 2000 color difference appended.
# The C driver can offer CSV files to process and programmatically check the calculations performed there.

#  Example of a CSV input line : 60.4,64,-25,63,100.2,17
#    Corresponding output line : 60.4,64,-25,63,100.2,17,17.543537557735508722843996959283
