...
2. `gcc -std=c99 -Wall -pedantic -Ofast -g tests/c/ciede-2000-driver.c -o ciede-2000-driver -lm`
3. `./ciede-2000-driver --generate 10000000 --output-file test-cases.csv`
4. `./ciede-2000-tests test-cases.csv | ./ciede-2000-driver`

Where the main files involved are [ciede-2000-driver.swift](ciede-2000-driver.swift#L82) for calculations and [test-swift.yml](../../.github/workflows/test-swift.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=46&a1=-62.8&b1=-10&L2=65&a2=-116.5&b2=-20) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
