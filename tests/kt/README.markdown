...
This implementation offers both **64-bit double precision** and **32-bit single precision** variants to suit various use cases.

## Implementation Details

The full source code, released on March 1, 2025, is available in two precision variants :
- **64-bit double precision** version: [Source code](../../ciede-2000.kt#L8) — [Archived copy](https://web.archive.org/web/...)  
- **32-bit single precision** version (suitable for most practical applications): [Source code](ciede-2000-single-precision.kt#L15)
