...
void main() {
	...
	for (var i = 0, k = 0; i < lab_set_1.length; ++i) {
		...
		for (var j = 0; j < lab_set_2.length; ++j) {
			...
			final double delta_e = ciede_2000(lab_1[0], lab_1[1], lab_1[2], lab_2[0], lab_2[1], lab_2[2]);
		...
		final List<Object> rgb_1 = rgb_set_1[i];
		final List<Object> rgb_2 = rgb_set_2[k];
		String str = "The closest color from " + rgb_1[3] + " = RGB(" + rgb_1[0].toString() + ", " + rgb_1[1].toString() + ", " + rgb_1[2].toString() + ") ";
		str += "is " + rgb_2[3] + " = RGB(" + rgb_2[0].toString() + ", " + rgb_2[1].toString() + ", " + rgb_2[2].toString() + ") ";
		str += "with a distance of " + min_delta_e.toStringAsFixed(5);
		print(str);
	}
}
