...
- [compare-hex-colors.dart](compare-hex-colors.dart#L175)
- [compare-rgb-colors.dart](compare-rgb-colors.dart#L175)
...
Where the main files involved are [ciede-2000-driver.dart](ciede-2000-driver.dart#L83) for calculations and [test-dart.yml](../../.github/workflows/test-dart.yml) for automation.
</details>
