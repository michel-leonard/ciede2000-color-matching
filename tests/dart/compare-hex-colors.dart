...
// L1 = 23.5   a1 = 12.3   b1 = 3.3
// L2 = 25.1   a2 = 18.5   b2 = -4.7
// CIE ΔE00 = 7.1525618463 (Bruce Lindbloom, Netflix’s VMAF, ...)
// CIE ΔE00 = 7.1525450554 (Gaurav Sharma, OpenJDK, ...)
...
// The goal of this demo in Dart/Flutter is to use the CIEDE2000 function to compare two hexadecimal colors.

void main() {
	final hex1 = '#00f';       // blue
	final hex2 = '#483D8B';    // darkslateblue

	// 1. hex -> RGB (0..255)
	final rgb1 = hex_to_rgb(hex1); // (r, g, b)
	final rgb2 = hex_to_rgb(hex2);

	print('$hex1 -> RGB(${rgb1[0]}, ${rgb1[1]}, ${rgb1[2]})');
	print('$hex2 -> RGB(${rgb2[0]}, ${rgb2[1]}, ${rgb2[2]})');

	// 2. RGB -> LAB
	final lab1 = rgb_to_lab(rgb1[0] / 255.0, rgb1[1] / 255.0, rgb1[2] / 255.0);
	final lab2 = rgb_to_lab(rgb2[0] / 255.0, rgb2[1] / 255.0, rgb2[2] / 255.0);

	print('$hex1 -> LAB(L: ${lab1[0].toStringAsFixed(4)}, a: ${lab1[1].toStringAsFixed(4)}, b: ${lab1[2].toStringAsFixed(4)})');
	print('$hex2 -> LAB(L: ${lab2[0].toStringAsFixed(4)}, a: ${lab2[1].toStringAsFixed(4)}, b: ${lab2[2].toStringAsFixed(4)})');

	// 3. Delta E 2000
	final deltaE = ciede_2000(lab1[0], lab1[1], lab1[2], lab2[0], lab2[1], lab2[2]);
	print('ΔE2000 between $hex1 and $hex2: ${deltaE.toStringAsFixed(4)}');
