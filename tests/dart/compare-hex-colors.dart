...
void main() {
	...
	for (var i = 0, k = 0; i < lab_set_1.length; ++i) {
		...
		final List<String> hex_1 = hex_set_1[i];
		final List<String> hex_2 = hex_set_2[k];
