...
This canonical **Java** implementation offers an easy way to calculate these differences accurately and programmatically.

## Overview

The presented algorithm enables your software to measure color similarity and differences with scientific accuracy.

To give you an idea, a ΔE2000 value above 12 usually means the colors are noticeably different to the human eye.
...
**Note** : L\* is generally between 0 and 100, a\* and b\* between -128 and +127.
...
1. `command -v javac > /dev/null || { sudo apt-get update && sudo apt-get install -y default-jdk ; }`
...
Where the main files involved are [ciede-2000-driver.java](ciede-2000-driver.java#L129) for calculations and [test-java.yml](../../.github/workflows/test-java.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=78.03&a1=-115.16&b1=-53.16&L2=96.25&a2=-8.91&b2=20.18) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Used in 30+ Languages](../../#implementations)
