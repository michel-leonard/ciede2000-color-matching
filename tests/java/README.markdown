...
- [compare-hex-colors.java](compare-hex-colors.java#L181)
- [compare-rgb-colors.java](compare-rgb-colors.java#L181)
...
Where the main files involved are [ciede-2000-driver.java](ciede-2000-driver.java#L87) for calculations and [test-java.yml](../../.github/workflows/test-java.yml) for automation.
</details>
...
> [!IMPORTANT]
> To correct this Java source code to exact match certain third-party ΔE2000 functions, follow the comments in the source code.
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=78.03&a1=-115.16&b1=-53.16&L2=96.25&a2=-8.91&b2=20.18) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
