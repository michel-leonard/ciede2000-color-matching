...
- A **64-bit double precision** version, which can be found [here](../../ciede-2000.java#L14) and is archived [here](https://web.archive.org/https://raw.githubusercontent.com/michel-leonard/ciede2000-color-matching/refs/heads/main/ciede-2000.java).
- A **32-bit single precision** version, <ins>suitable for most practical applications</ins>, is available [here](ciede-2000-single-precision.java#L21).
...
Where the two main files involved are [ciede-2000-testing.java](ciede-2000-testing.java#L121) and [raw-java.yml](../../.github/workflows/raw-java.yml).
</details>
