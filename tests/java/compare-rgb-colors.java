...
public class Main {
	...
	// L1 = 22.5   a1 = 35.9   b1 = -2.0
	// L2 = 21.9   a2 = 29.8   b2 = 2.1
	// CIE ΔE00 = 3.5295033063 (Bruce Lindbloom, Netflix’s VMAF, ...)
	// CIE ΔE00 = 3.5294885927 (Gaurav Sharma, OpenJDK, ...)
	...
	// The goal of this demo in Java is to use the CIEDE2000 function to compare two RGB colors.

	public static void main(String[] args) {

		int r1 = 0, g1 = 0, b1 = 139; // darkblue
		int r2 = 0, g2 = 0, b2 = 128; // navy

		System.out.printf("#1 -> RGB(%d, %d, %d)%n", r1, g1, b1);
		System.out.printf("#2 -> RGB(%d, %d, %d)%n", r2, g2, b2);

		// 1. RGB -> LAB
		double[] lab1 = rgb_to_lab(r1 / 255.0, g1 / 255.0, b1 / 255.0);
		double[] lab2 = rgb_to_lab(r2 / 255.0, g2 / 255.0, b2 / 255.0);

		System.out.printf("#1 -> LAB(L: %.4f, a: %.4f, b: %.4f)%n", lab1[0], lab1[1], lab1[2]);
		System.out.printf("#2 -> LAB(L: %.4f, a: %.4f, b: %.4f)%n", lab2[0], lab2[1], lab2[2]);

		// 2. Delta E 2000
		double deltaE = ciede_2000(lab1[0], lab1[1], lab1[2], lab2[0], lab2[1], lab2[2]);
		System.out.printf("ΔE2000 between #1 and #2 %.2f%n", deltaE);
