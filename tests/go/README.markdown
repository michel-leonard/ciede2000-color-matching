...
Where the main files involved are [ciede-2000-driver.go](ciede-2000-driver.go#L97) for calculations and [raw-dart.go](../../.github/workflows/test-go.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=65&a1=-50&b1=10.5&L2=20.82&a2=71&b2=-34.1) — [32-bit vs 64-bit](https://github.com/michel-leonard/ciede2000-color-matching#numerical-precision-32-bit-vs-64-bit) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
