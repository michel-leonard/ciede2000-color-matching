...
```go
// Example usage of the CIEDE2000 function in Golang
...
Where the two main files involved are [ciede-2000-testing.go](ciede-2000-testing.go#L125) and [raw-go.yml](../../.github/workflows/raw-go.yml).
</details>
