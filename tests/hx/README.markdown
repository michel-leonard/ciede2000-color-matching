...
ΔE2000 is the current standard for quantifying color differences aligned with human visual perception.

This canonical **Haxe** implementation offers an easy way to calculate these differences accurately and programmatically.
...
1. `command -v haxe > /dev/null || { sudo apt-get update && sudo apt-get install -y haxe ; }`
...
Where the main files involved are [ciede-2000-driver.hx](ciede-2000-driver.hx#L126) for calculations and [test-hx.yml](../../.github/workflows/test-hx.yml) for automation.
</details>
...
![ΔE2000 Logo](../../docs/assets/images/logo.jpg)
