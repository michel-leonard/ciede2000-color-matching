...
# L1 = 12.996         a1 = -44.3          b1 = -49.2225
# L2 = 12.996         a2 = -44.262        b2 = -49.2225
# CIE ΔE2000 = ΔE00 = 0.01303718997

# L1 = 61.43          a1 = 36.0           b1 = 94.7492
# L2 = 61.53          a2 = 36.0           b2 = 94.7492
# CIE ΔE2000 = ΔE00 = 0.08617310611

# L1 = 76.8           a1 = -51.0          b1 = 17.5675
# L2 = 76.8           a2 = -51.0          b2 = 16.8944
# CIE ΔE2000 = ΔE00 = 0.32402319306

# L1 = 47.0           a1 = 6.434          b1 = -83.21
# L2 = 47.0           a2 = 7.7            b2 = -84.3
# CIE ΔE2000 = ΔE00 = 0.47680153703

# L1 = 8.23           a1 = -83.2057       b1 = 31.663
# L2 = 8.23           a2 = -83.2057       b2 = 37.12
# CIE ΔE2000 = ΔE00 = 1.87748806862

# L1 = 7.0227         a1 = -61.5          b1 = 21.0
# L2 = 7.0227         a2 = -61.5          b2 = 15.713
# CIE ΔE2000 = ΔE00 = 2.36749005238

# L1 = 64.0           a1 = 59.2           b1 = -11.0
# L2 = 66.9653        a2 = 56.7855        b2 = -14.5093
# CIE ΔE2000 = ΔE00 = 3.00778113846

# L1 = 23.6           a1 = 74.62          b1 = -43.0401
# L2 = 24.9           a2 = 70.89          b2 = -51.0
# CIE ΔE2000 = ΔE00 = 3.53909607912

# L1 = 57.5875        a1 = -8.789         b1 = 50.7957
# L2 = 66.7           a2 = -39.6          b2 = 72.32
# CIE ΔE2000 = ΔE00 = 15.79977345341

# L1 = 85.765         a1 = -32.125        b1 = 127.0
# L2 = 21.691         a2 = -59.0          b2 = -64.938
# CIE ΔE2000 = ΔE00 = 89.74679272364
...
rgb_1 = [0, 0, 255]    # Blue color in RGB
rgb_2 = [102, 51, 153] # Rebecca Purple color in RGB

# Normalize RGB to [0,1], then convert to CIELAB
lab_1 = rgb_to_lab(*rgb_1.map! { |i| i / 255.0 })
lab_2 = rgb_to_lab(*rgb_2.map! { |i| i / 255.0 })
