...
The full source code released on March 1, 2025, is available [here](../../ciede-2000.jl#L9) and archived [here](https://web.archive.org/https://raw.githubusercontent.com/michel-leonard/ciede2000-color-matching/refs/heads/main/ciede-2000.jl).
...
Where the two main files involved are [ciede-2000-testing.jl](ciede-2000-testing.jl#L120) and [raw-jl.yml](../../.github/workflows/raw-jl.yml).
</details>
