<a name="browse"></a>
Browse : [MATLAB](../m/#browse) · [Nim](../nim/#browse) · [Pascal](../pas/#browse) · [Perl](../pl/#browse) · [PHP](../php/#browse) · [PowerShell](../ps1/#browse) · [Prolog](../pro/#browse) · **Python** · [R](../r/#browse) · [Racket](../rkt/#browse) · [Ruby](../rb/#browse) · [Rust](../rs/#browse) · [Scala](../scala/#browse) · [SQL](../sql/#browse) · [Swift](../swift/#browse)
...
<details>
<summary>Do you have an implementation of ΔE2000 that uses NumPy to vectorize calculations ?</summary>

Yes, the [ciede-2000-numpy.py](ciede-2000-numpy.py#L6) file contains an implementation of CIEDE2000 which offers better performance than native Python, thanks to NumPy, and 80 rigorous tests are included.
</details>
