...
The developed algorithm enables your software to measure color similarity and differences with scientific rigor.
...
Compared to the well-established Python library **colormath** — first released in 2008 and still widely used 17 years later — this implementation of the ΔE2000 color difference formula, tested on millions of color pairs, shows an absolute deviation of no more than 10⁻¹². As first in [C99](../c#comparison-with-the-vmaf-c99-library), this once again confirms the accuracy and numerical stability of this algorithm.
