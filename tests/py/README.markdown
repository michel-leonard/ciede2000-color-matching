...
The full source code is available [here](../../ciede-2000.py#L6), and is archived [here](https://web.archive.org/https://raw.githubusercontent.com/michel-leonard/ciede2000-color-matching/refs/heads/main/ciede-2000.py).
...
Compared to the well-established Python library **colormath**, this implementation of the ΔE2000 **color difference** formula — tested on millions of color pairs — exhibits an absolute deviation of no more than **1e-12**, validating both the correctness and numerical stability of the algorithm.
