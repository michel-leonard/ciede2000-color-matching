...
1. `command -v php > /dev/null || { sudo apt-get update && sudo apt-get install -y php-cli ; }`
...
Where the main files involved are [ciede-2000-driver.php](ciede-2000-driver.php#L121) for calculations and [test-php.yml](../../.github/workflows/test-php.yml) for automation.
</details>
