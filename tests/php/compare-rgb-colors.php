...
// L1 = 63.6   a1 = 26.1   b1 = 5.3
// L2 = 61.1   a2 = 20.1   b2 = -3.0
// CIE ΔE00 = 6.5372292834 (Bruce Lindbloom, Netflix’s VMAF, ...)
// CIE ΔE00 = 6.5372445197 (Gaurav Sharma, OpenJDK, ...)
...
// The goal of this demo in PHP is to use the CIEDE2000 function to compare two RGB colors.

[$r_1, $g_1, $b_1] = [0, 0, 139]; // darkblue
[$r_2, $g_2, $b_2] = [0, 0, 128]; // navy

// 1. RGB -> LAB
[$l_1, $a_1, $b_1_lab] = rgb_to_lab($r_1 / 255.0, $g_1 / 255.0, $b_1 / 255.0);
[$l_2, $a_2, $b_2_lab] = rgb_to_lab($r_2 / 255.0, $g_2 / 255.0, $b_2 / 255.0);

printf("RGB(%3d, %3d, %3d) -> LAB(L: %.5g, a: %.5g, b: %.5g)\n", $r_1, $g_1, $b_1, $l_1, $a_1, $b_1_lab);
