...
1. `gcc -std=c99 -Wall -pedantic -Ofast -g tests/c/ciede-2000-driver.c -o ciede-2000-driver.exe -lm`
...
Where the main files involved are [ciede-2000-driver.ps](ciede-2000-driver.ps1#L90) for calculations and [test-ps1.yml](../../.github/workflows/test-ps1.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=22&a1=-120&b1=28&L2=87.18&a2=-87&b2=-33.18) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
