...
- A **64-bit double precision** version, which can be found [here](../../ciede-2000.c#L13) and is archived [here](https://web.archive.org/https://raw.githubusercontent.com/michel-leonard/ciede2000-color-matching/refs/heads/main/ciede-2000.c).
- A **32-bit single precision** version, <ins>suitable for most practical applications</ins>, is available [here](ciede-2000-single-precision.c#L20).
...
Where the two main files involved are [ciede-2000-testing.c](ciede-2000-testing.c#L125) and [raw-c.yml](../../.github/workflows/raw-c.yml).
</details>
