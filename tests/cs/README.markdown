...
The full source code released on March 1, 2025, is available [here](../../ciede-2000.cs#L6) and archived [here](https://web.archive.org/https://raw.githubusercontent.com/michel-leonard/ciede2000-color-matching/refs/heads/main/ciede-2000.cs).
...
Where the two main files involved are [ciede-2000-testing.cs](ciede-2000-testing.cs#L118) and [raw-cs.yml](../../.github/workflows/raw-cs.yml).
</details>
