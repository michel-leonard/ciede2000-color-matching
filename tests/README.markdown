...
```sh
gcc -std=c99 -Wall -pedantic -Ofast -g tests/c/ciede-2000-driver.c -o ciede-2000-driver -lm
```
...
To validate implementations of the ΔE2000 function, **104 color pairs** from the reference data of the German-based research institute for the graphic arts are included ([see dataset](datasets/reference-data-4.txt)) in static tests. The 40+ programming languages we support pass these tests, each independently.
