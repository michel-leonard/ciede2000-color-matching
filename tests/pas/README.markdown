...
Where the main files involved are [ciede-2000-driver.pas](ciede-2000-driver.pas#L95) for calculations and [test-pas.yml](../../.github/workflows/test-pas.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=44.4&a1=10&b1=-52.1&L2=23&a2=-25&b2=1) — [32-bit vs 64-bit](https://github.com/michel-leonard/ciede2000-color-matching#numerical-precision-32-bit-vs-64-bit) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
