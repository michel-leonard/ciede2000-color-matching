...
```cpp
// Compute the Delta E (CIEDE2000) color difference between two Lab colors in C++
...
Where the main files involved are [ciede-2000-driver.cpp](ciede-2000-driver.cpp#L91) for calculations and [test-cpp.yml](../../.github/workflows/test-cpp.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=45&a1=65.26&b1=-37.27&L2=78.78&a2=-80&b2=-108) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
