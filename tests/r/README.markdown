...
This canonical vectorized implementation of ΔE2000 written in **R** enables reliable and precise calculation of color differences.
...
1. `command -v Rscript > /dev/null || { sudo apt-get update && sudo apt-get install r-base ; }`
...
Where the main files involved are [ciede-2000-driver.r](ciede-2000-driver.r#L82) for calculations and [test-r.yml](../../.github/workflows/test-r.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=6&a1=-102&b1=105&L2=88.2&a2=-123&b2=50) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 30+ Languages](../../#implementations)
