...
Of course, it works with `decimal.js` included in the source code, both in the browser and on Node.js, and its source code is [here](ciede-2000-multiprecision.js#L45).
</details>
