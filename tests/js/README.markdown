<a name="browse"></a>
Browse : [Excel](../xls/#browse) · [F#](../fs/#browse) · [Fortran](../f90/#browse) · [Go](../go/#browse) · [Haskell](../hs/#browse) · [Haxe](../hx/#browse) · [Java](../java/#browse) · **JavaScript** · [Julia](../jl/#browse) · [Kotlin](../kt/#browse) · [Lua](../lua/#browse) · [Mathematica](../wl/#browse) · [MATLAB](../m/#browse) · [Nim](../nim/#browse) · [Pascal](../pas/#browse)
...
Of course, it works with `decimal.js` included in the source code, both in the browser and on Node.js, and its source code is [here](ciede-2000-multiprecision.js#L40).
</details>
