...
// L1 = 66.1   a1 = 24.8   b1 = 4.6
// L2 = 66.7   a2 = 30.3   b2 = -4.1
// CIE ΔE00 = 6.0771971996 (Bruce Lindbloom, Netflix’s VMAF, ...)
// CIE ΔE00 = 6.0771831645 (Gaurav Sharma, OpenJDK, ...)
...
// The goal of this demo in JavaScript is to use the CIEDE2000 function to compare two hexadecimal colors.

const hex_1 = "#00f"; // blue
const hex_2 = "#483D8B"; // darkslateblue

// 1. hex -> RGB (0..255)
const [r_1, g_1, b_1] = hex_to_rgb(hex_1);
const [r_2, g_2, b_2] = hex_to_rgb(hex_2);
console.log(`${hex_1.padEnd(8)} -> RGB(${r_1}, ${g_1}, ${b_1})`);
console.log(`${hex_2.padEnd(8)} -> RGB(${r_2}, ${g_2}, ${b_2})`);
...
console.log(`${hex_1.padEnd(8)} -> LAB(L: ${l_1.toFixed(4)}, a: ${a_1.toFixed(4)}, b: ${b_1_lab.toFixed(4)})`);
console.log(`${hex_2.padEnd(8)} -> LAB(L: ${l_2.toFixed(4)}, a: ${a_2.toFixed(4)}, b: ${b_2_lab.toFixed(4)})`);

// 3. Delta E 2000
const delta_e = ciede_2000(l_1, a_1, b_1_lab, l_2, a_2, b_2_lab);
console.log(`ΔE2000 between ${hex_1} and ${hex_2}: ${delta_e.toFixed(4)}`);
