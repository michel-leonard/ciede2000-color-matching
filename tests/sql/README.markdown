...
ΔE2000 is the internationally accepted standard for perceptual color difference measurement.

This canonical **SQL**-based implementation offers an easy way to calculate these differences accurately within the database.
...
Where the database is `my-demo`, and the other files involved are [ciede-2000.sql](../../ciede-2000.sql#L8) for calculations and [test-sql-mariadb.yml](../../.github/workflows/test-sql-mariadb.yml) for automation.
</details>
...
Where the main files involved are [ciede-2000.pg.sql](ciede-2000.pg.sql#L6) for calculations and [test-sql-postgresql.yml](../../.github/workflows/test-sql-postgresql.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=1.59&a1=71.28&b1=-121.95&L2=93.68&a2=-109.14&b2=-97.84) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Used in 30+ Languages](../../#implementations)
