...
Where the database is `my-demo`, and the other files involved are [ciede-2000.sql](../../ciede-2000.sql) for calculations and [test-sql-mariadb.yml](../../.github/workflows/test-sql-mariadb.yml) for automation.
</details>
