<a name="browse"></a>
Browse : [Haxe](../hx/#browse) · [Java](../java/#browse) · [JavaScript](../js/#browse) · [Julia](../jl/#browse) · [Kotlin](../kt/#browse) · [Lua](../lua/#browse) · [Mathematica](../wl/#browse) · **MATLAB** · [Nim](../nim/#browse) · [Pascal](../pas/#browse) · [Perl](../pl/#browse) · [PHP](../php/#browse) · [PowerShell](../ps1/#browse) · [Prolog](../pro/#browse) · [Python](../py/#browse)
...
The full source code, last updated on March 1, 2025, can be viewed [here](../../ciede-2000.m#L6) and archived [here](https://web.archive.org/https://raw.githubusercontent.com/michel-leonard/ciede2000-color-matching/refs/heads/main/ciede-2000.m).
...
Two ways of calling the ΔE<sub>00</sub> function are provided :
- `ciede_2000` accepts six floating-point scalars representing two individual colors in L\*a\*b\* space.
- `ciede_2000` accepts vectors of color components for batch processing multiple color pairs simultaneously.

A simple **Delta E 2000** calculation between 2 colors in the **L\*a\*b\* color space** is done using the `ciede_2000` function :
