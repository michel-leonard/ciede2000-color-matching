...
Basic Calculator produces ΔE<sub>00</sub> results with arbitrary precision. Set `scale=50` before calling the `ciede_2000` function to get around 40 digits :
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=54&a1=-36&b1=113&L2=26.7&a2=-68&b2=69) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
