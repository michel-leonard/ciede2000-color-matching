...
The full source code, which corresponds to both Fortran 2008 and 2018, is available [here](../../ciede-2000.f90#L16) and archived [here](https://web.archive.org/https://raw.githubusercontent.com/michel-leonard/ciede2000-color-matching/refs/heads/main/ciede-2000.f90).
...
Where the two main files involved are [ciede-2000-testing.f90](ciede-2000-testing.f90#L126) and [raw-f90.yml](../../.github/workflows/raw-f90.yml).
</details>
