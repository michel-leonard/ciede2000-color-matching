...
This algorithm enables your software to measure color similarity and differences with scientific rigor.

For reference, two very distinct colors typically have a ΔE2000 value greater than 12.

Lower values indicate greater closeness, making ΔE2000 a **state-of-the-art method** for color comparison.
...
To compare **hexadecimal** (e.g., "#FFF") or **RGB colors** using the CIEDE2000 function, see implementations in multiple languages :
- [AWK](../awk#-flexibility)
...
1. `command -v gfortran > /dev/null || { sudo apt-get update && sudo apt-get install -y gfortran ; }`
...
Where the main files involved are [ciede-2000-driver.f90](ciede-2000-driver.f90#L131) for calculations and [test-f90.yml](../../.github/workflows/test-f90.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=26&a1=-85.62&b1=-82.8&L2=45.3&a2=26.58&b2=-50.15) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Used in 30+ Languages](../../#implementations)
