...
This canonical implementation in **Lua** offers a simple way of calculating these differences accurately and programmatically.
...
Where the main files involved are [ciede-2000-driver.lua](ciede-2000-driver.lua#L84) for calculations and [test-lua.yml](../../.github/workflows/test-lua.yml) for automation.
</details>
...
Tested on 100 million random L\*a\*b\* color pairs against the official **tiny-devicons-auto-colors** implementation, this Lua function showed a perfect match with zero error and a maximum difference of 4 × 10<sup>-13</sup>, [once again](../#dynamic-tests-with-established-libraries) confirming its accuracy and production-ready status.
