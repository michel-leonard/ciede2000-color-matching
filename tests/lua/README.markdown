...
An [all-in-one](compare-rgb-hex-colors.lua#L143) function accepts RGB and hexadecimal formats and calculates ΔE2000 using illuminant D65.
...
Where the main files involved are [ciede-2000-driver.lua](ciede-2000-driver.lua#L82) for calculations and [test-lua.yml](../../.github/workflows/test-lua.yml) for automation.
</details>
