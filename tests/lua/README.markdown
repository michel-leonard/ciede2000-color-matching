...
The full source code released on March 1, 2025, is available [here](../../ciede-2000.lua#L6) and archived [here](https://web.archive.org/https://raw.githubusercontent.com/michel-leonard/ciede2000-color-matching/refs/heads/main/ciede-2000.lua).
...
Where the two main files involved are [ciede-2000-testing.lua](ciede-2000-testing.lua#L115) and [raw-lua.yml](../../.github/workflows/raw-lua.yml).
</details>
