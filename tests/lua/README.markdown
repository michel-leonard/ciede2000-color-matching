<a name="browse"></a>
Browse : [Go](../go/#browse) · [Haskell](../hs/#browse) · [Haxe](../hx/#browse) · [Java](../java/#browse) · [JavaScript](../js/#browse) · [Julia](../jl/#browse) · [Kotlin](../kt/#browse) · **Lua** · [Mathematica](../wl/#browse) · [MATLAB](../m/#browse) · [Nim](../nim/#browse) · [Pascal](../pas/#browse) · [Perl](../pl/#browse) · [PHP](../php/#browse) · [PowerShell](../ps1/#browse)
...
Where the main files involved are [ciede-2000-driver.lua](ciede-2000-driver.lua#L97) for calculations and [test-lua.yml](../../.github/workflows/test-lua.yml) for automation.
</details>
