...
function ciede_2000(r_1, g_1, b_1, r_2, g_2, b_2)
	...
	if r_1 < 0.040448236276933 then r_1 = r_1 / 12.92 else r_1 = ((r_1 + 0.055) / 1.055) ^ 2.4 end
	if r_2 < 0.040448236276933 then r_2 = r_2 / 12.92 else r_2 = ((r_2 + 0.055) / 1.055) ^ 2.4 end
	if g_1 < 0.040448236276933 then g_1 = g_1 / 12.92 else g_1 = ((g_1 + 0.055) / 1.055) ^ 2.4 end
	if g_2 < 0.040448236276933 then g_2 = g_2 / 12.92 else g_2 = ((g_2 + 0.055) / 1.055) ^ 2.4 end
	if b_1 < 0.040448236276933 then b_1 = b_1 / 12.92 else b_1 = ((b_1 + 0.055) / 1.055) ^ 2.4 end
	if b_2 < 0.040448236276933 then b_2 = b_2 / 12.92 else b_2 = ((b_2 + 0.055) / 1.055) ^ 2.4 end
