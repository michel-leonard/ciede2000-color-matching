...
-- L1 = 82.1   a1 = 24.3   b1 = 2.4
-- L2 = 82.3   a2 = 29.2   b2 = -2.5
-- CIE ΔE00 = 3.8700515572 (Bruce Lindbloom, Netflix’s VMAF, ...)
-- CIE ΔE00 = 3.8700367580 (Gaurav Sharma, OpenJDK, ...)
...
-- in Lua/LuaJIT displays the original line with the computed Delta E 2000 color difference appended.
-- The C driver can offer CSV files to process and programmatically check the calculations performed there.

--  Example of a CSV input line : 78.7,111,2.2,79,124,-14
--    Corresponding output line : 78.7,111,2.2,79,124,-14,5.068663981450850511625256703627
