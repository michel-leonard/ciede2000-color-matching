...
// L1 = 86.6           a1 = -36.028        b1 = 36.7
// L2 = 86.6           a2 = -36.0          b2 = 36.7
// CIE ΔE2000 = ΔE00 = 0.01151075973

// L1 = 25.1647        a1 = -49.27         b1 = -124.5
// L2 = 25.1647        a2 = -48.996        b2 = -124.7222
// CIE ΔE2000 = ΔE00 = 0.08429866063

// L1 = 83.0           a1 = 110.7          b1 = 7.0
// L2 = 83.0           a2 = 110.7          b2 = 2.32
// CIE ΔE2000 = ΔE00 = 1.49478099761

// L1 = 32.07          a1 = 119.0          b1 = -68.39
// L2 = 32.07          a2 = 110.0          b2 = -70.19
// CIE ΔE2000 = ΔE00 = 2.01211957173

// L1 = 2.4776         a1 = -99.144        b1 = 6.1111
// L2 = 2.4776         a2 = -98.589        b2 = 0.15
// CIE ΔE2000 = ΔE00 = 2.40021307074

// L1 = 3.0            a1 = -33.2          b1 = 62.6
// L2 = 3.0            a2 = -29.4213       b2 = 70.35
// CIE ΔE2000 = ΔE00 = 3.4437436765

// L1 = 90.3           a1 = 45.1           b1 = 70.0
// L2 = 97.22          a2 = 45.1           b2 = 64.1
// CIE ΔE2000 = ΔE00 = 4.70510040039

// L1 = 11.0           a1 = -83.0          b1 = 76.202
// L2 = 40.0           a2 = -76.226        b2 = 70.614
// CIE ΔE2000 = ΔE00 = 21.3524132432

// L1 = 34.2387        a1 = -84.98         b1 = 57.0
// L2 = 23.28          a2 = -87.84         b2 = -13.1
// CIE ΔE2000 = ΔE00 = 27.40629999206

// L1 = 26.0           a1 = 88.8           b1 = -61.0
// L2 = 98.228         a2 = 56.287         b2 = 110.465
// CIE ΔE2000 = ΔE00 = 86.92571657466
...
fn main() {
	...
	let (r_1, g_1, b_1) = (0, 0, 139); // darkblue
	let (r_2, g_2, b_2) = (0, 0, 128); // navy

	println!("#1 -> RGB({}, {}, {})", r_1, g_1, b_1);
	println!("#2 -> RGB({}, {}, {})", r_2, g_2, b_2);
	...
	println!("#1 -> LAB(L: {:.4}, a: {:.4}, b: {:.4})", l_1, a_1, b_1_lab);
	println!("#2 -> LAB(L: {:.4}, a: {:.4}, b: {:.4})", l_2, a_2, b_2_lab);

	// 2. Delta E 2000
	let delta_e = ciede_2000(l_1, a_1, b_1_lab, l_2, a_2, b_2_lab);
	println!("ΔE2000 between #1 and #2 {:.4}", delta_e);
