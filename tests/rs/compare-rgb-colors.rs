...
// L1 = 12.4   a1 = 11.5   b1 = -3.3
// L2 = 11.3   a2 = 17.1   b2 = 5.0
// CIE ΔE00 = 7.1692095356 (Bruce Lindbloom, Netflix’s VMAF, ...)
// CIE ΔE00 = 7.1692246394 (Gaurav Sharma, OpenJDK, ...)
...
// The goal of this demo in Rust is to use the CIEDE2000 function to compare two RGB colors.
