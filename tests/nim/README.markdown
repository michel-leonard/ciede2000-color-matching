...
The full source code is available [here](../../ciede-2000.nim#L10), and is archived [here](https://web.archive.org/https://raw.githubusercontent.com/michel-leonard/ciede2000-color-matching/refs/heads/main/ciede-2000.nim).
...
<summary>What is the testing procedure ?</summary>
 ...
 2. `nim c --opt:speed -r tests/nim/ciede_2000_testing.nim 10000000 | ./verifier > test-output.txt`
</details>
