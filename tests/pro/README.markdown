...
```prolog
% Compute the Delta E (CIEDE2000) color difference between two Lab colors in Prolog

color_1([19.3166, 73.5, 122.428]).
color_2([19.0, 76.2, 91.372]).
...
compute_delta_e :-
	...
	format('Delta E 2000 = ~15f~n', [DeltaE]).
...
Where the main files involved are [ciede-2000-driver.pro](ciede-2000-driver.pro#L135) for calculations and [test-pro.yml](../../.github/workflows/test-pro.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=64.38&a1=100.89&b1=-53.17&L2=7.05&a2=-67.98&b2=65.23) — [32-bit vs 64-bit](https://github.com/michel-leonard/ciede2000-color-matching#numerical-precision-32-bit-vs-64-bit) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
