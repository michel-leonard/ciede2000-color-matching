...
// L1 = 31.1   a1 = 44.3   b1 = -3.1
// L2 = 30.0   a2 = 49.0   b2 = 3.6
// CIE ΔE00 = 3.8819626940 (Bruce Lindbloom, Netflix’s VMAF, ...)
// CIE ΔE00 = 3.8819758389 (Gaurav Sharma, OpenJDK, ...)
...
// in D displays the original line with the computed Delta E 2000 color difference appended.
// The C driver can offer CSV files to process and programmatically check the calculations performed there.

//  Example of a CSV input line : 70.5,108,-60,72,101.1,7
//    Corresponding output line : 70.5,108,-60,72,101.1,7,18.909971190740740469801080793422
...
void main(string[] args) {
	...
	auto inputLines  = file.byLine();
	foreach (rawLine; inputLines) {
		const auto line = stripRight!(isWhite)(rawLine.idup);
		const auto a = line.split(',');
		const auto v = a.map!(to!double).array;
		const double deltaE = ciede_2000(v[0], v[1], v[2], v[3], v[4], v[5]);
		writefln("%s,%.17f", line, deltaE);
	}
}
