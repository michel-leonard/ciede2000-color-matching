...
Where the two main files involved are [ciede-2000-testing.d](ciede-2000-testing.d#L121) and [raw-d.yml](../../.github/workflows/raw-d.yml).
</details>
...
This function was measured at a speed of 975,470 calls per second.
