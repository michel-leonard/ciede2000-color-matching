...
This canonical **VBA** implementation provides an easy and precise way to compute perceptual color differences programmatically.
...
Lower values indicate greater similarity between colors, making this a **state-of-the-art method** for perceptual comparison.
...
For comparisons using **hexadecimal** (e.g. `#FFF`) or **RGB** color formats, see corresponding implementations in other languages :
- [AWK](../awk#-flexibility)
...
1.
```sh
params="-q --timeout=5 --read-timeout=0 --tries=1"
########################################################################################
...
Where the main files involved are [ciede-2000-driver.bas](ciede-2000-driver.bas#L135) for calculations and [test-bas.yml](../../.github/workflows/test-bas.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=31.19&a1=96.6&b1=108.6&L2=79.3&a2=-8&b2=-2.8) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Used in 30+ Languages](../../#implementations)
