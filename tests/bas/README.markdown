...
4. Paste the VBA source code for function `ciede_2000`.
...
Where the main files involved are [ciede-2000-driver.bas](ciede-2000-driver.bas#L101) for calculations and [test-bas.yml](../../.github/workflows/test-bas.yml) for automation.
</details>
...
[Calculator](https://michel-leonard.github.io/ciede2000-color-matching/lab-color-calculator.html?L1=31.8&a1=56.39&b1=27.1&L2=61&a2=85&b2=111.57) — [Workflow Details](../../.github/workflows#workflow-details) — 🌐 [Suitable in 40+ Languages](../../#implementations)
