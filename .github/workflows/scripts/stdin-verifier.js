...
// The verification is done here, with Node.js, which reads the CSV file from STDIN.
// The script prints a message at the end and exits with a code 0 if successful, 1 otherwise.
...
rl.once('close', () => {
	...
	process.exit(n_success !== 0 && n_errors === 0 ? 0 : 1)
})
