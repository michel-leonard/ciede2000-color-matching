...
A JavaScript-based verifier is also [available](../../tests/js/stdin-verifier.js#L76); it behaves like the C99 verifier, runs with Node.js, and is used for cross-verification between C99 and JavaScript implementations.
