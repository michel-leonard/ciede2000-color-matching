...
function rgb_to_xyz(r, g, b)
	...
	if r < 0.040448236276933 then r = r / 12.92 else r = ((r + 0.055) / 1.055) ^ 2.4 end
	if g < 0.040448236276933 then g = g / 12.92 else g =  ((g + 0.055) / 1.055) ^ 2.4 end
	if b < 0.040448236276933 then b = b / 12.92 else b = ((b + 0.055) / 1.055) ^ 2.4 end
...
function xyz_to_rgb(x, y, z)
	...
	if r < 0.0031306684424956 then x = 12.92 * r else x = 1.055 * r ^ (1.0 / 2.4) - 0.055 end
	if g < 0.0031306684424956 then y = 12.92 * g else y = 1.055 * g ^ (1.0 / 2.4) - 0.055 end
	if b < 0.0031306684424956 then z = 12.92 * b else z = 1.055 * b ^ (1.0 / 2.4) - 0.055 end
